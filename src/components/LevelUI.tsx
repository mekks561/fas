...
export const LevelUI: React.FC<LevelUIProps> = ({
    ...
    const getLevelStateText = useCallback((state: LevelState): string => {
        switch (state) {
            ...
            case LevelState.PLAYING: return 'Playing';
            case LevelState.WAVE_INCOMING: return 'Wave Incoming';
            case LevelState.WAVE_ACTIVE: return 'Wave Active';
            case LevelState.WAVE_COMPLETE: return 'Wave Complete';
            case LevelState.BOSS_APPROACHING: return 'Boss Approaching';
            case LevelState.BOSS_FIGHT: return 'Boss Fight';
            case LevelState.LEVEL_COMPLETE: return 'Level Complete!';
            case LevelState.GAME_OVER: return 'Game Over';
            case LevelState.PAUSED: return 'Paused';
            default: return '';
        }
    }, []);
            ...
            {isBossActive && bossMaxHealth > 0 && (
                <div className="absolute top-20 left-1/2 transform -translate-x-1/2 w-96">
                    <div className="bg-black/80 rounded-lg p-3 border-2 border-red-600">
                        <div className="text-red-500 text-lg font-bold text-center mb-2">
                            {bossName}
                        </div>
...
export const WaveAnnouncement: React.FC<WaveAnnouncementProps> = ({
    ...
    return (
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
            <div className={`rounded-2xl px-12 py-8 border-4 ${
