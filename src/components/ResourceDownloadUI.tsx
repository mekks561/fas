...
export const ResourceDownloadUI: React.FC<ResourceDownloadUIProps> = ({
  ...
  return (
    <div
      className={`fixed inset-0 flex items-center justify-center bg-black/80 backdrop-blur-sm z-50 transition-opacity duration-500 ${fadeOut ? 'opacity-0' : 'opacity-100'}`}
    >
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="space-y-2">
              <div className="flex justify-between text-sm">
                <span className="text-gray-300">{progress.currentAsset || '准备中...'}</span>
            ...
            <div className="grid grid-cols-3 gap-4 text-center">
              <div className="bg-gray-800/50 rounded-lg p-3">
                <div className="text-2xl font-bold text-blue-400">{progress.loadedAssets}</div>
              ...
              <div className="bg-gray-800/50 rounded-lg p-3">
                <div className="text-2xl font-bold text-red-400">{progress.errors.length}</div>
