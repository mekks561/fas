        ...
        <div className="flex justify-between">
          ...
          >
            ...
            {skillCooldowns.skill1 > 0 && (
              <span className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-sm font-bold text-white/90 drop-shadow">{getSkillCooldownText(skillCooldowns.skill1)}</span>
            )}
          </button>
          ...
          >
            ...
            {skillCooldowns.skill2 > 0 && (
              <span className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-sm font-bold text-white/90 drop-shadow">{getSkillCooldownText(skillCooldowns.skill2)}</span>
            )}
          </button>
        </div>
        ...
        <div className="flex justify-between items-center">
          ...
          >
            ...
            {skillCooldowns.skill3 > 0 && (
              <span className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-sm font-bold text-white/90 drop-shadow">{getSkillCooldownText(skillCooldowns.skill3)}</span>
            )}
          </button>
          ...
          >
            ...
            {skillCooldowns.skill4 > 0 && (
              <span className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-sm font-bold text-white/90 drop-shadow">{getSkillCooldownText(skillCooldowns.skill4)}</span>
            )}
          </button>
