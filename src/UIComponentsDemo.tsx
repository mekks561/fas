  ...
  return (
    <div className="example-section">
      ...
      <div className="example-row">
        ...
        <Button variant="danger" leftIcon={<Icon name="close" size={16} />}>
          退出游戏
        </Button>
      </div>
...
export const HealthBarExamples: React.FC = () => {
  ...
  return (
    <div className="example-section">
      ...
      {/* 基础生命条 */}
      <div className="example-row vertical">
        <HealthBar value={health} maxValue={100} label="生命值" showValue />
      ...
      {/* 护盾条 */}
      <div className="example-row vertical">
        <HealthBar value={shield} maxValue={100} color="blue" label="护盾值" />
      ...
      {/* 低血量动画 */}
      <div className="example-row vertical">
        <HealthBar value={20} maxValue={100} label="低血量 (20%)" animation="pulse" />
        <HealthBar value={10} maxValue={100} label="危急血量 (10%)" animation="flash" />
      </div>
      ...
      {/* 精确数值显示 */}
      <div className="example-row vertical">
        <HealthBar value={75} maxValue={100} showExactValue label="精确数值 (75/100)" />
      </div>
    </div>
  );
};
...
export const TextExamples: React.FC = () => {
  return (
    <div className="example-section">
      ...
      {/* 渐变效果 */}
      <div className="example-row vertical">
        <Text variant="h2" gradient="primary">
          渐变主色调
        </Text>
        <Text variant="h2" gradient="fire">
          火焰渐变
        </Text>
        <Text variant="h2" gradient="ice">
          冰霜渐变
        </Text>
      </div>
      ...
      {/* 发光效果 */}
      <div className="example-row vertical">
        <Text variant="h2" glow glowColor="#3b82f6">
          蓝色发光
        </Text>
        <Text variant="h2" glow glowColor="#ef4444">
          红色发光
        </Text>
        <Text variant="h2" glow glowColor="#22c55e">
          绿色发光
        </Text>
      </div>
    </div>
