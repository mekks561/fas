...
export class EffectSystem {
  ...
  private effectCallbacks: Map<EffectType, ((active: boolean, value: number) => void)[]> =
    new Map();
  ...
  public subscribeToEffect(
    type: EffectType,
    callback: (active: boolean, value: number) => void,
  ): void {
