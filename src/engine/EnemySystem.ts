...
export class EnemySystem {
  ...
  private waveConfig: WaveConfig[] = [
    ...
    { enemies: [{ type: EnemyType.SCOUT, count: 2 }, { type: EnemyType.FIGHTER, count: 2 }], spawnDelay: 1800 },
    { enemies: [{ type: EnemyType.FIGHTER, count: 3 }, { type: EnemyType.TANK, count: 1 }], spawnDelay: 1500 },
    { enemies: [{ type: EnemyType.ELITE, count: 3 }, { type: EnemyType.FIGHTER, count: 2 }], spawnDelay: 1200 },
    { enemies: [{ type: EnemyType.BOSS, count: 1 }, { type: EnemyType.ELITE, count: 2 }], spawnDelay: 1000 },
  ];
