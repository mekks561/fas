...
export class PBRMaterialSystem {
  ...
  public createMaterial(name: string, type: MaterialType, config?: MaterialConfig): pc.StandardMaterial {
  ...
  public createEnemyMaterial(type: 'scout' | 'fighter' | 'tank' | 'elite' | 'boss'): pc.StandardMaterial {
    switch (type) {
      case 'scout':
