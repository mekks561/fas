...
export class EnhancedEnemySystem {
    ...
    this.waveConfigs = [
      ...
      },
      {
        enemies: [
          ...
          { type: EnemyType.ASSASSIN, count: 2 },
        ],
        spawnDelay: 1000,
        difficulty: 2.5,
        isBossWave: false,
      ...
      {
        enemies: [
          { type: EnemyType.SUPPORT, count: 2 },
          { type: EnemyType.ELITE, count: 3 },
        ],
        spawnDelay: 1100,
        difficulty: 2.8,
  ...
  private spawnEnemy(): void {
    ...
    const enemy = new EnhancedEnemy(this.engine, type, new pc.Vec3(x, height, z), this.player);
  ...
  public checkCollisions(
    projectiles: { active: boolean; entity: pc.Entity; damage: number }[],
  ): number {
    let hits = 0;
