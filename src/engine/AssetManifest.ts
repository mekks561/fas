    ...
    ships.forEach((ship) => {
      this.addAsset('player-ships', {
        ...
        lodVariants: [
          {
            level: 0,
            url: `/assets/models/player/${ship.id}-low.glb`,
            size: ship.size * 0.3,
            quality: 'low',
          },
          {
            level: 1,
            url: `/assets/models/player/${ship.id}-med.glb`,
            size: ship.size * 0.6,
            quality: 'medium',
          },
          {
    ...
    bosses.forEach((boss) => {
      this.addAsset('bosses', {
        ...
        lodVariants: [
          {
            level: 0,
            url: `/assets/models/bosses/${boss.id}-low.glb`,
            size: boss.size * 0.2,
            quality: 'low',
          },
          {
            level: 1,
            url: `/assets/models/bosses/${boss.id}-med.glb`,
            size: boss.size * 0.5,
            quality: 'medium',
          },
          {
